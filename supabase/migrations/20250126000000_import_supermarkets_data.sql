/*
  ...
  基于supermarket.md文件的最新数据，包含所有67家超市
  包括全国连锁、华人超市、韩国超市、亚洲超市等
*/
...
('Pak''nSave Papanui 2', 'Pak''nSave（Papanui）', '171 Main North Rd, Papanui', -43.496, 172.597, '+64 3 352 4001', '7:00 AM - 10:00 PM', 4.1),
...
CREATE INDEX IF NOT EXISTS idx_supermarkets_name_en ON supermarkets(name_en);
CREATE INDEX IF NOT EXISTS idx_supermarkets_name_zh ON supermarkets(name_zh);

-- 验证数据导入
SELECT COUNT(*) as total_supermarkets FROM supermarkets;
SELECT name_en, name_zh, location FROM supermarkets LIMIT 5;
